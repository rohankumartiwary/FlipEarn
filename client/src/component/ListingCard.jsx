...
import { BadgeCheckIcon, LineChart, MapPin, User } from 'lucide-react';
      ...
      <div className='p-5 pt-8'>
        ...
        <div className='flex items-center gap-3 mb-3'>
            ...
            <div className='flex flex-col'>
                <h2>{listing.title}</h2>
                <p>@{listing.username}-<span className='capitalize'></span>{listing.platform}</p>
            </div>
        ...
        <div className='flex flex-wrap justify-between max-w-lg items-center gap-3 my-5'>
            <div className='flex items-center text-sm text-gray-600'>
                ...
                >{listing.followers_count.toLocaleString()}</span>
                Followers
            </div>
            {
        ...
        <div className='flex items-center gap-3 mb-3'>
            <span className='text-xs font-medium bg-pink-100 text-pink-600 px-3 py-1 rounded-full captilalized'></span>
