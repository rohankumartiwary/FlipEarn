            ...
            <div className='bg-white sm:rounded-lg shadow-2xl w-full max-w-lg h-screen sm:h-[320px] flex flex-col'>
                ...
                <form onSubmit={handleSubmission}
                    ...
                    {Credential.map((cred, index) => (
                        <div key={cred.type}
                            ...
                            <input type='text' value={cred.value} onChange={(e) => setCredential((prev) => prev.map((c, i) => (i === index ? { ...c, value: e.target.value } : c)))}
                                className='w-full px-2 py-2 py-1.5 text-sm border border-gray-300 rounded outline-indigo-400'
                            />
                    ...
                    <div className='flex items-center gap-2'>
                        <input type="text" value={newField} onChange={(e) => setNewField(e.target.value)} placeholder='feild name.....'
                            className='outline-none border-b border-gray border-gray-200' />
