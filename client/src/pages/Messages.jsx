    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='py-10'>
        ...
        {loading ? (
          ...
          <div className='bg-white rounded-lg shadpw-xs border border-gray-200 p-16 text-center'>
            <div className='w-16 h-16 bg-gray-100 rounded-full flex items-center justif-center mx-auto mb-4'>
            ...
            <p className='text-gray-600'>
              {searchQuery ? "Try a diffrent search terms" : `Start a conversation by viewing a listing and clicking "Chat with seller"`}
            </p>
          </div>
        ) :
          <div className='bg-white rounded-lg shadow-xs border border-gray-200 divide-y divide-gray-200'>
            {filteredChats.map((chat) => {
              ...
              return (
                ...
                className='w-full p-4 hover:bg-gray-100 transition-colors text-left' key={chat.id}>
