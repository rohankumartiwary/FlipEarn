...
import { ArrowLeftIcon, ArrowRightFromLine, ArrowUpRightFromSquare, ArrowUpRightFromSquareIcon, Calendar1Icon, CheckCircle, CheckCircle2, ChevronLeftIcon, ChevronRightIcon, DollarSign, Eye, LineChart, Link, Loader2Icon, MapPin, MessageSquareMoreIcon, ShoppingBagIcon, Users } from 'lucide-react';
  ...
  return listing ? (
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-start max-md:flex-col gap-10'>
        <div className='flex-1 max-md:w-full'>
          ...
          {images?.length > 0 && (
            <div className='bg-white rounded-xl border border-gray-200 mb-5'>
              <div className='p-4'>
                <h4
                  className='font-semibold text-gray-800'>ScreenShot & Proof
                </h4>
              </div>
                ...
                <div className='absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2'>
                  {images.map((_,index)=>(
                    <button onClick={()=>setCurrent(index)}
                     key={index} className={`w-2.5 h-2.5 rounded-full ${current===index ? "bg-indigo-600" : "bg-gray-600"}`}/>
                  ))}
                </div>
              </div>
            </div>
          ...
          <div className='bg-white rounded-xl border border-gray-200 mb-5'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center'>
              <div>
               ...
               <div>
                <Calendar1Icon className='mx-auto text-gray-400 w-5 h-5 mb-1'/>
                <p className='font-semibold text-gray-800'>
          ...
          <div className='bg-white rounded-xl border border-gray-200 mb-5'>
            ...
            <div className=' p-4 text-xs text-gray-600'>{listing.description}</div>
          </div>
          ...
          {/* Aditonal Details */}
           ...
           <div className='bg-white rounded-xl border border-gray-200 mb-5'>
            <div className='p-4 border-b border-gray-100'>
              <h4 className='font-semibold text-gray-800'>Additonal Details</h4>
            </div>
        ...
        <div className='bg-qhite min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10'>
          ...
          <button onClick={loadChatBox} className=' w-full text-white bg-indigo-600 py-2 rounded-lg hover:bg-indigo-700 transition text-sm font-medium flex items-center justify-center gap-2'>
