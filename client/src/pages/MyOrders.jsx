...
import { CheckCircle2, ChevronDown, ChevronUp, Code, Copy, Loader2Icon } from 'lucide-react';
          ...
          return (
            <div key={id} className='bg-white rounded-lg border border-gray-200 p-5 flex flex-col max-w-4xl'>
                  ...
                  <div className='flex items-start justify-between gap-4'>
                    <div className=''>
                      ...
                      <p className='text-sm text-gray-500 mt-1'>
                          @{listing.username} . <span className='capatlize'>{listing.platform}</span>
                      </p>
              ...
              <div className='flex flex-col gap-2 items-end'>
                          ...
                          onClick={(()=>setIsExpanded((p)=>(p===id ? null : id)))}
                          ...
                          <div className='text-xs text-gray-500 mt-2 text-right'>
                              <div>
                                Credentials Purchased : {format(new Date(order.createdAt),"MMM d,yyyy")}
                              </div>
                          </div>
              </div>
                            ...
                            <div className='mt-4 md:mt-0 pt-4'>
                              <div className='space-y-2'>
                                {credential.updatedCredential.map((cred)=>(
                                  <div key={cred.name} className='flex items-center flex-start justify-between gap-3 bg-gray-50 rounded-md p-2'>
                                    <div>
